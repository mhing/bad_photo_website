...
(function() {
  var displayPhoto, updateCarouselIndex;

  updateCarouselIndex = function(element, action) {
    var activeElement, elementList, newElement, newIndex, oldIndex, orderedList, _i, _j, _len, _len1;
    if (action === 'prev') {
      orderedList = document.getElementsByTagName("OL")[0];
      ...
      if (action === 'next') {
        orderedList = document.getElementsByTagName("OL")[0];
        elementList = orderedList.getElementsByTagName("LI");
        for (_j = 0, _len1 = elementList.length; _j < _len1; _j++) {
          element = elementList[_j];
          if (element.className === 'active') {
            activeElement = element;
          }
        }
  ...
  displayPhoto = function(newIndex) {
    var div, divList, photo, photoDiv, photos, _i, _j, _len, _len1;
    divList = document.getElementsByTagName("DIV");
    for (_i = 0, _len = divList.length; _i < _len; _i++) {
      div = divList[_i];
    ...
    return photos[newIndex].setAttribute("class", "item active");
  };

  $(function() {
    return $("a[data-slide]").click(function() {
      var action;
      action = $(this).data("slide");
      return updateCarouselIndex(this, action);
    });
  });
